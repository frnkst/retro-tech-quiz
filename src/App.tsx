...
export default function App() {
    return (
        <>
            ...
            <div className="App flex-col flex align-middle w-screen justify-center py-10">
                <input
                    placeholder="Name"
                    type="text"
                    ...
                    className="retro-font self-center w-5/6 text-white py-10 px-6 text-grey-darkest text-center text-5xl rounded-md bg-gray-800 border-dashed placeholder-white"
                />
                <Categories />
            </div>
        </>
